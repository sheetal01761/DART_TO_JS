...
(function dartProgram() {
  ...
  function installTearOff(
    ...
    if (typeof reflectionInfo == "number") reflectionInfo += typesOffset;
    var name = funsOrNames[0];
    fun.$stubName = name;
    var getterFunction = tearOff(
      funs,
      applyIndex || 0,
      reflectionInfo,
      isStatic,
    ...
    if (isStatic) fun.$tearOff = getterFunction;
  }
  ...
  var C = {},
    H = {
      ...
      ioore: function (receiver, index) {
        if (receiver == null) J.get$length$as(receiver);
      ...
      Closure_fromTearOff: function (
        ...
        var $constructor,
          ...
          $prototype = isStatic
            ...
            : Object.create(
                new H.BoundClosure(null, null, null, "").constructor.prototype
              );
        ...
        for (applyTrampoline = trampoline, i = 1; i < functions.length; ++i) {
          ...
          if (stubCallName != null) {
            stub = isStatic
              ? stub
              : H.Closure_forwardCallTo(receiver, stub, isIntercepted);
      ...
      Closure__computeSignatureFunctionNewRti: function (
        functionType,
        isStatic,
        isIntercepted
      ) {
        ...
        if (typeof functionType == "string") {
          ...
          typeEvalMethod = isIntercepted
            ? H.BoundClosure_evalRecipeIntercepted
            : H.BoundClosure_evalRecipe;
      ...
      Closure_cspForwardCall: function (
        arity,
        isSuperCall,
        stubName,
        $function
      ...
      Closure_forwardCallTo: function (receiver, $function, isIntercepted) {
        ...
        t1 =
          $function == null
            ? lookedUpFunction == null
            : $function === lookedUpFunction;
        t2 = !t1 || arity >= 27;
        if (t2)
        ...
        if (arity === 0) {
          ...
          return new Function(
            t1 +
              (t2 == null
                ? ($.BoundClosure_selfFieldNameCache =
                    H.BoundClosure_computeFieldNamed("self"))
                : t2) +
              ";return " +
              selfName +
              "." +
      ...
      Closure_cspForwardInterceptedCall: function (
        arity,
        isSuperCall,
        $name,
        $function
      ...
      Closure_forwardInterceptedCallTo: function (receiver, $function) {
        ...
        if (receiverField == null)
          receiverField = $.BoundClosure_receiverFieldNameCache =
            H.BoundClosure_computeFieldNamed("receiver");
        stubName = $function.$stubName;
        arity = $function.length;
        lookedUpFunction = receiver[stubName];
        t1 =
      ...
      BoundClosure_computeFieldNamed: function (fieldName) {
        ...
        throw H.wrapException(
          P.ArgumentError$("Field name " + fieldName + " not found.")
        );
      },
      ...
      _substituteFunctionParameters: function (
        universe,
        functionParameters,
        typeArguments,
        depth
      ...
      _functionRtiToString: function (functionType, genericContext, bounds) {
        ...
        if (bounds != null) {
          ...
          for (
            ...
            t4 = t3 - 1 - i;
            if (t4 < 0) return H.ioore(genericContext, t4);
      ...
      _rtiToString: function (rti, genericContext) {
        ...
        if (kind === 13) {
          ...
          t1 = t2 - 1 - t1;
          if (t1 < 0 || t1 >= t2) return H.ioore(genericContext, t1);
      ...
      _Universe_findErasedType: function (universe, cls) {
        ...
        if (probe == null) return H._Universe_eval(universe, cls, false);
          ...
          $arguments = [];
          for (i = 0; i < $length; ++i) $arguments.push(erased);
      ...
      _Universe__createQuestionRti: function (
        universe,
        baseType,
        key,
        normalize
      ...
      _Universe__createFutureOrRti: function (
        universe,
        baseType,
        key,
        normalize
      ...
      _Universe__lookupFunctionRti: function (
        universe,
        returnType,
        parameters
      ) {
      ...
      _Universe__lookupGenericFunctionRti: function (
        universe,
        baseFunctionType,
        bounds,
        normalize
      ...
      _Universe__createGenericFunctionRti: function (
        universe,
        baseFunctionType,
        bounds,
        key,
      ...
      _Parser_handleIdentifier: function (
        parser,
        start,
        source,
        stack,
      ...
      _isInterfaceSubtype: function (universe, s, sEnv, t, tEnv) {
        ...
        for (i = 0; i < $length; ++i)
          if (
            !H._isSubtype(
              universe,
              H._Universe_evalInEnvironment(universe, s, supertypeArgs[i]),
              sEnv,
              tArgs[i],
              tEnv
            )
      ...
      Rti: function Rti(t0, t1) {
        ...
        _._as = t0;
        _._is = t1;
        _._cachedRuntimeType =
          _._specializedTestResource =
          _._precomputed1 =
            null;
        _._kind = 0;
        _._canonicalRecipe =
    ...
    P = {
      ...
      List_List$filled: function ($length, fill, $E) {
        ...
        result = J.JSArray_markFixedList(
          H.setRuntimeTypeInfo(new Array($length), $E._eval$1("JSArray<0>")),
          $E
        );
        if ($length !== 0 && true)
      ...
      StringBuffer__writeAll: function (string, objects, separator) {
        var t1 = H._arrayInstanceType(objects),
          iterator = new J.ArrayIterator(
            objects,
            objects.length,
            t1._eval$1("ArrayIterator<1>")
          );
        if (!iterator.moveNext$0()) return string;
        t1 = t1._precomputed1;
        if (separator.length === 0) {
          do string += H.S(t1._as(iterator._current));
      ...
      IterableBase_iterableToFullString: function (
        iterable,
        leftDelimiter,
        rightDelimiter
      ) {
    ...
    V = {
      fillarrayy: function () {
        ...
        for (j = 43, n = 1; j <= 55; ++j) {
          for (k = j, i = n; i <= 13; ++i) {
            t1 = $.$get$arrayy();
            (t1 && C.JSArray_methods).$indexSet(t1, i * 29 + k, 7);
            --k;
          }
          ++n;
        }
      ...
      main: function () {
        ...
        t1 = $.$get$arrayy();
        t2 = t1[166];
        if (t2 === 7) (t1 && C.JSArray_methods).$indexSet(t1, 166, 9);
        else if (t2 < 7) V.nonempty(138);
        t1 = $.$get$arrayy();
        t2 = t1[164];
        if (t2 === 7) (t1 && C.JSArray_methods).$indexSet(t1, 164, 9);
        else if (t2 < 7) V.nonempty(134);
        t1 = $.$get$arrayy();
        t2 = t1[222];
        if (t2 === 7) (t1 && C.JSArray_methods).$indexSet(t1, 222, 9);
        else if (t2 < 7) V.nonempty(250);
        t1 = $.$get$arrayy();
        t2 = t1[224];
        if (t2 === 7) (t1 && C.JSArray_methods).$indexSet(t1, 224, 9);
        else if (t2 < 7) V.nonempty(254);
        t1 = $.$get$arrayy();
        t2 = t1[192];
        if (t2 === 7) (t1 && C.JSArray_methods).$indexSet(t1, 192, 9);
        else if (t2 < 7) V.nonempty(190);
        t1 = $.$get$arrayy();
        t2 = t1[196];
        if (t2 === 7) (t1 && C.JSArray_methods).$indexSet(t1, 196, 9);
        else if (t2 < 7) V.nonempty(198);
      },
      nonempty: function (x) {
        var t2,
          t1 = $.$get$arrayy();
        t1.length;
        if (x < 0 || x >= 609) return H.ioore(t1, x);
        if (t1[x] === 7) {
          (t1 && C.JSArray_methods).$indexSet(t1, x, 9);
          t1 = $.$get$arrayy();
          t2 = x - 28;
          t1.length;
          if (t2 < 0) return H.ioore(t1, t2);
          if (t1[t2] < 7) V.nonempty(t2 - 28);
          t1 = $.$get$arrayy();
          t2 = x - 30;
          t1.length;
          if (t2 < 0) return H.ioore(t1, t2);
          if (t1[t2] < 7) V.nonempty(t2 - 30);
          t1 = $.$get$arrayy();
          t2 = x + 28;
          t1.length;
          if (t2 >= 609) return H.ioore(t1, t2);
          if (t1[t2] < 7) V.nonempty(t2 + 28);
          t1 = $.$get$arrayy();
          t2 = x + 30;
          t1.length;
  ...
  H.BoundClosure.prototype = {
    toString$0: function (_) {
      ...
      if (receiver == null) receiver = this._self;
      return (
        "Closure '" +
        H.S(this._name) +
        "' of " +
        ("Instance of '" +
          H.Primitives_objectTypeName(type$.Object._as(receiver)) +
          "'")
      );
    },
  };
  ...
  P.ConcurrentModificationError.prototype = {
    toString$0: function (_) {
      return (
        ...
        P.Error_safeToString(this.modifiedObject) +
        "."
      );
    },
  };
  ...
  H._Universe_addRules(
    init.typeUniverse,
    JSON.parse(
      '{"JSBool":{"bool":[]},"JSArray":{"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[]},"JSNumNotInt":{"num":[]},"JSString":{"String":[]},"int":{"num":[]}}'
    )
  );
  0;
  ...
  (function staticFields() {
    ...
    $._toStringVisiting = H.setRuntimeTypeInfo(
      [],
      H.findType("JSArray<Object>")
    );
  })();
  (function lazyInitializers() {
    var _lazy = hunkHelpers.lazy;
    _lazy($, "arrayy", "$get$arrayy", function () {
      return P.List_List$filled(609, 0, type$.int);
    });
  })();
